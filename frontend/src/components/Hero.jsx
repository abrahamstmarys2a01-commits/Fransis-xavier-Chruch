...
const Hero = () => {
  return (
    <section id="home" className="relative bg-brand-blue">
      ...
      <div className="relative min-h-[500px] py-24 lg:py-32 flex flex-col justify-center overflow-hidden bg-brand-blue">
        ...
        <div className="absolute inset-0 z-0 bg-gradient-to-b lg:bg-gradient-to-r from-brand-blue via-brand-blue/80 to-transparent"></div>
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 pt-24 lg:pt-0">
          ...
          >
            <div className="flex items-center space-x-4 mb-6">
              <span className="text-brand-gold font-medium tracking-[0.2em] text-sm uppercase">WELCOME TO</span>
              <div className="h-[2px] w-12 bg-brand-gold"></div>
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-4 font-serif leading-tight">
              St. Francis Xavier<br/>Church
            </h1>
            
            <p className="text-xl text-brand-gold tracking-widest mb-6 font-medium">
              Faith • Hope • Love
            </p>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              <a href="#about" className="inline-flex items-center justify-center px-8 py-3.5 bg-brand-gold text-brand-blue font-semibold rounded-full hover:bg-brand-gold-hover transition-colors duration-300">
                Explore Our Church
                <FaArrowRight className="ml-3" />
              </a>
              <a href="#contact" className="inline-flex items-center justify-center px-8 py-3.5 bg-transparent border border-white text-white font-semibold rounded-full hover:bg-white hover:text-brand-blue transition-colors duration-300">
                Contact Us
              </a>
            </div>
          </motion.div>
      ...
      {/* Features Section */}
      <div className="bg-brand-ivory py-20 px-4">
